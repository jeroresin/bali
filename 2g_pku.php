...
<!DOCTYPE html >
  ...
  ?>
	...
	<table width=100% Align="center" bgcolor="#A4A4A4">
		<tr>
			<td width=10%><form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<b>Level :</b>
	...
	<!--<font color="#ffffff"><?echo "SELECT Distinct ".$aggrselect." FROM ".$aggr."2GDay WHERE Region='Sumbagteng' ORDER BY ".$aggrselect ?></font>-->
