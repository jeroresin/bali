...
<div id="mySidenav" class="sidenav">
      ...
      <div class="col-sm-12">
        <div class="chart-wrapper">
          ...
          <div class="chart-stage style1">
              ...
              <?php include('pages/2gmap.php'); ?> 
          </div>
          <div class="chart-notes style1">PEKANBARU
       <?php
  ...
  ?>
  <img src="http://www.googlemapsmarkers.com/v1/H/FA5858/"> HUAWEI: <?php echo $num_rows_c1; ?> <img src="http://www.googlemapsmarkers.com/v1/E/0099FF/"> NON HUAWEI: <?php echo $num_rows_c2; ?>  </div>
        </div>
      </div>
      <div class="col-sm-12">
        <div class="chart-wrapper">
          ...
          <div class="chart-stage">
			 <?php include('pages/form3gpkuh.php'); ?>
...
<!-- end of three -->
	...
	<?php include('pages/chart3gpkuh.php'); ?>

    <hr>

    <p class="small text-muted">Built with &#9829; by <a href="">FebrikaErifian@Huawei</a></p>
