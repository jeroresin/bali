	...
	<div class="col-md-12">
		<div class="row">
			<form id="filter-form" class="form-inline" method="POST"> 
				<?php
				$regsql = "select distinct Cluster from Site3GDayClust"; 
				$result = mysql_query($regsql); 
				$regsql1 = "select distinct SITEID from Site3GDayClust where Cluster ='$id'"; 
...
$("#filter-form").submit(function(e){
	...
	$.ajax({
		url: "pages/ajax/3gregdayqrypkuh.php",
		type: 'POST',
		data: data,
		async: false,
